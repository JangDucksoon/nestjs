    ...
    <div class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
        <div class="bg-white rounded-lg shadow-lg p-6 w-80">
            ...
            <div class="mt-4 flex justify-end space-x-2">
                <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-4 rounded-md" on:click={() => show = false}>
                    Cancel
                </button>
                <button class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-md" on:click={sendPassword}>
                    Confirm
                </button>
            </div>
        </div>
